...
namespace NV.CT.Service.HardwareTest.UserControls.Universal.Interfaces
{
    public class UniversalImageViewer
    {
        ...
        {
            /** 获取loggerService **/
            logService = Ioc.Default.GetRequiredService<ILogService>();
            /** 初始化前置准备 **/
        ...
        {
            logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: Start Initialize UniversalImageViewer {width}*{height}");
            /** 实例化 WrapperCLI **/
            cliWrapper = new NvImageViewerWrapperCLI();
            /** 初始化 WindowFormsHost **/
            XWindowsFormsHost = new WindowsFormsHost();
            XWindowsFormsHost.Background = new SolidColorBrush(Color.FromRgb(0, 0, 0));
        ...
        {
            logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: Start UniversalImageViewer RegisterEvents");
        ...
        public void ClearView()
        {
            ...
            {
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: Start UniversalImageViewer ClearViewData");
                cliWrapper.ClearViewData(imageViewHandle);
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: End UniversalImageViewer ClearViewData");
            });
        }
        ...
        public void ResetView()
        {
            XWindowsFormsHost.Dispatcher.Invoke(() =>
            {
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: Start UniversalImageViewer ResetView");
                cliWrapper.RemoveSeriesAllROI(imageViewHandle);
                cliWrapper.ResetView(imageViewHandle);
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: End UniversalImageViewer ResetView");
            });
        }
        ...
        public void LoadRawDataList(IEnumerable<ImageRawDataInfo> rawDataList, List<DetectorMap> detectorMaps)
        {
            XWindowsFormsHost.Dispatcher.Invoke(() =>
            {
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: Start UniversalImageViewer SetImageRawDataList");
                cliWrapper.SetDetectorMap(imageViewHandle, detectorMaps);
                cliWrapper.SetImageRawDataList(imageViewHandle, rawDataList.ToList(), true);
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: End UniversalImageViewer SetImageRawDataList");
            });
        }
        ...
        public void SetDisplayIndex(int index) 
        {
            XWindowsFormsHost.Dispatcher.Invoke(() =>
            {
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: Start UniversalImageViewer SetDisplayIndex");
                cliWrapper.SetSliceIndex(imageViewHandle, index);
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: End UniversalImageViewer SetDisplayIndex");
            });
        }
        ...
        public void SortRawDataList(IEnumerable<int> sortedIDs)
        {
            XWindowsFormsHost.Dispatcher.Invoke(() =>
            {
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: Start UniversalImageViewer SortRawDataList");
                cliWrapper.ChangeRawDataListOrder(imageViewHandle, sortedIDs.ToList());
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: End UniversalImageViewer SortRawDataList");
            });
        }
        ...
        public void AddRawData(ImageRawDataInfo rawData)
        {
            XWindowsFormsHost.Dispatcher.Invoke(() =>
            {
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: Start UniversalImageViewer AddRawData");
                cliWrapper.AddRawData(imageViewHandle, rawData);
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: End UniversalImageViewer AddRawData");
            });
        }
        ...
        public void AddRawDataRange(IEnumerable<ImageRawDataInfo> rawDataList)
        {
            XWindowsFormsHost.Dispatcher.Invoke(() =>
            {
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: Start UniversalImageViewer AddRawDataRange");
                cliWrapper.AddRawDataRange(imageViewHandle, rawDataList.ToList());
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: End UniversalImageViewer AddRawDataRange");
            });
        }
        ...
        public void DeleteRawData(int id)
        {
            XWindowsFormsHost.Dispatcher.Invoke(() =>
            {
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: Start UniversalImageViewer DeleteRawData");
                cliWrapper.DeleteRawData(imageViewHandle, id);
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: End UniversalImageViewer DeleteRawData");
            });
        }
        ...
        public void LoadDicomSeries(string directory)
        {
            XWindowsFormsHost.Dispatcher.Invoke(() =>
            {
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: Start UniversalImageViewer LoadDicomSeries");
                cliWrapper.SetViewDataFloder(imageViewHandle, directory);
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: End UniversalImageViewer LoadDicomSeries");
            });
        }
        ...
        public void EnableScrollSlicing(bool enable) 
        {
            if (enable)
            {
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: Start UniversalImageViewer Scroll Slicing.");
            ...
            {
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: End UniversalImageViewer Scroll Slicing.");
        ...
        {       
            if (enable)
            {
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: Start UniversalImageViewer Zoom.");
                cliWrapper.SetViewMouseAction(imageViewHandle, MouseButton.LeftMouseButton, ViewMouseAction.BrowserMouseAction_Zoom, 0);
            }
            else
            {
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: End UniversalImageViewer Zoom.");
        ...
        {        
            if (enable)
            {
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: Start UniversalImageViewer DragMove.");
                cliWrapper.SetViewMouseAction(imageViewHandle, MouseButton.LeftMouseButton, ViewMouseAction.BrowserMouseAction_Move, 0);
            }
            else
            {
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: End UniversalImageViewer DragMove.");
                cliWrapper.SetViewMouseAction(imageViewHandle, MouseButton.LeftMouseButton, ViewMouseAction.MouseAction_None, 0);
            }     
        }
        ...
        {        
            if (enable)
            {
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: Start UniversalImageViewer Rotate.");
                cliWrapper.SetViewMouseAction(imageViewHandle, MouseButton.LeftMouseButton, ViewMouseAction.BrowserMouseAction_Rotate, 0);
            }
            else
            {
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: End UniversalImageViewer Rotate.");
                cliWrapper.SetViewMouseAction(imageViewHandle, MouseButton.LeftMouseButton, ViewMouseAction.MouseAction_None, 0);
            }        
        }
        ...
        {          
            if (enable)
            {
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: Start UniversalImageViewer WWWL.");
                cliWrapper.SetViewMouseAction(imageViewHandle, MouseButton.LeftMouseButton, ViewMouseAction.BrowserMouseAction_WWWL, 0);
            }
            else
            {
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: End UniversalImageViewer WWWL.");
                cliWrapper.SetViewMouseAction(imageViewHandle, MouseButton.LeftMouseButton, ViewMouseAction.MouseAction_None, 0);
            }        
        }
        ...
        {
            logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: Switch to OneToOnePixel.");
            cliWrapper.OneToOnePixels(imageViewHandle, true);
        }

        public void SwitchBackFromOneToOnePixel() 
        {
            logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: Switch back from OneToOnePixel.");
        ...
        public void CreateRectangleROI(bool enable)
        {
            if (enable)
            {
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: Start UniversalImageViewer Rectangle ROI.");
            ...
            {
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: End UniversalImageViewer Rectangle ROI.");
                cliWrapper.SetViewMouseAction(imageViewHandle, MouseButton.LeftMouseButton, ViewMouseAction.MouseAction_None, 0);
            }
        }
        ...
        public void CreateCircleROI(bool enable)
        {
            if (enable)
            {
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: Start UniversalImageViewer Circle ROI.");
        ...
        public void CreateRectangleWWWL(bool enable) 
        {
            if (enable)
            {
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: Start UniversalImageViewer Rectangle WW/WL.");
            ...
            {
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: End UniversalImageViewer Rectangle WW/WL.");
                cliWrapper.SetViewMouseAction(imageViewHandle, MouseButton.LeftMouseButton, ViewMouseAction.MouseAction_None, 0);
            }
        }
        ...
        {
            logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: Remove ROI.");
            cliWrapper.RemoveSeriesAllROI(imageViewHandle);
        }
        ...
        public void DrawHorizontalLine(double y, double[] rgb)
        {
            XWindowsFormsHost.Dispatcher.Invoke(() =>
            {
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: Start UniversalImageViewer DrawHorizontalLine");
                cliWrapper.CreateCalibrationLine(imageViewHandle, 0, y, rgb);
                logService.Info(ServiceCategory.HardwareTest, $"[UniversalImageViewer] Action info: End UniversalImageViewer DrawHorizontalLine");
            });
        }
