...
{
    /// <summary>
    /// SliceThicknessAxialUC.xaml 的交互逻辑
    /// </summary>
    public partial class SliceThicknessAxialUC
    {
        /// <summary>
        /// 控件和对应Rect框的字典缓存
        /// </summary>
        ...
        public SliceThicknessAxialUC(IMessagePrintService printLog, IIntegrationPhantomService integrationPhantomService)
        {
            InitializeComponent();
            _printLog = printLog;
        ...
        private void Calculate(ItemEntryModel model, SeriesImageControl ic)
        {
            ...
            var stRes = AlgMethods.SliceThicknessAxial(stParam, ConfigFolder);
            float st;
