...
{
    /// <summary>
    /// ContrastScaleUC.xaml 的交互逻辑
    /// </summary>
    public partial class ContrastScaleUC
    {
        /// <summary>
        /// 控件和对应ROI框的字典缓存
        /// </summary>
        ...
        public ContrastScaleUC(IMessagePrintService printLog, IIntegrationPhantomService integrationPhantomService)
        {
            InitializeComponent();
            _printLog = printLog;
        ...
        {
            var position = _integrationPhantomService.GetAirPosition();
