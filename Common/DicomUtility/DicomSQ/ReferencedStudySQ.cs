...
{
    public class ReferencedStudySQ : IDicomDatasetUpdater
    {
        public SopInstanceReferenceMacro SopInstanceReferenceMacro { get; set; }

        public ReferencedStudySQ()
        {
        ...
        {
            var sequenceDS = DicomContentHelper.TryGetDicomSequence(ds, DicomTag.ReferencedStudySequence);
