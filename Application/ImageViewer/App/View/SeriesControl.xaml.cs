...
public partial class SeriesControl
{
    ...
    private void OnPreviewMouseMove(object sender, MouseEventArgs e)
    {
            ...
            Math.Abs(diff.Y) > SystemParameters.MinimumVerticalDragDistance)
        {
            ...
            EventAggregator.Instance.GetEvent<UpdateSelectedImageModel>().Publish(passedData);
        }
    }
    ...
    private void DataGridOnPreviewMouseMove(object sender, MouseEventArgs e)
    {
        if (e.LeftButton != MouseButtonState.Pressed)
        {
            return;
            ...
            Math.Abs(diff.Y) > SystemParameters.MinimumVerticalDragDistance)
        {
            if (sender is DataGrid dataGrid)
            {
                ...
                SeriesModel selectedItem = (SeriesModel)dataGrid.SelectedItem;
                DataObject dragData = new DataObject(GeneralImageViewer.DragObjectKey, selectedItem.SeriesPath);
                ...
                EventAggregator.Instance.GetEvent<UpdateSelectedSeriesModel>().Publish(selectedItem);
            }
        }
    }
