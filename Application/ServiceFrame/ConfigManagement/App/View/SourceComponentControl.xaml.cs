...
public partial class SourceComponentControl : UserControl, IServiceControl
{
    public SourceComponentControl()
    {
        InitializeComponent();
        DataContext = CTS.Global.ServiceProvider?.GetRequiredService<SourceComponentViewModel>();
    }
