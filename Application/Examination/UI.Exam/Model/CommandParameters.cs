...
public class CommandParameters
{
    ...
    public const string IMAGE_OPERATE_ADD = "Crop";
    public const string IMAGE_OPERATE_DEL = "Crop";
    #endregion
    ...
    public const string COMMAND_SAVE_CONFIG = "SaveConfigCommand";
    ...
    public const string COMMAND_ISVALIDATED = "IsValidated";
    ...
    public const string COMMAND_TIMELINENEXT = "TimelineNextCommand";
    public const string COMMAND_TIMELINEBACK = "TimelineBackCommand";

    public const string COMMAND_SETTINGTUBEPOSITION = "SettingTubePositionCommand";
    ...
    public const string COMMAND_SHOW = "ShowPostProcessSettingWindow";
    public const string COMMAND_CONFIRM_POSTPROCESS = "ConfirmPostProcessSettingCommand";
    #endregion
}