...
{
    /// <summary>
    /// RawDataManagementWindow.xaml 的交互逻辑
    /// </summary>
    public partial class RawDataManagementWindow : Window
    {
        private readonly RawDataManagementViewModel? _viewModel;

        public RawDataManagementWindow()
        {
            ...
            _viewModel = Global.Instance.ServiceProvider.GetRequiredService<RawDataManagementViewModel>();
