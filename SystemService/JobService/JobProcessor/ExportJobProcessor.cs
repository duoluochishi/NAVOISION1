...
using NV.CT.JobService.JobExecutor;
...
namespace NV.CT.JobService
{
    public class ExportJobProcessor : IHostedService, IJobProcessor
    {
        ...
        private void TryRunNextJob()
        {
            ...
            DicomUtility.Transfer.ITaskExecutor exportTaskExecutor = null;
        ...
        private void Process(DicomUtility.Transfer.ITaskExecutor exportExecutor, ExportJobRequest jobParameter)
        {
